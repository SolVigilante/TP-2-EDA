...
Lequel dice que está en inglés. Esta falla podría ser porque el escoces y el inglés tiene muchos trigramas y recuencias parecidas. Además, el texto es muy corto y sumado a lo anterior produce una falla en la lógica.  
...
El texto dice que está en Afrikaans cuando realmente está en inglés. El poblema puede ser con las mayúsculas. Es probable que el corpus de ingles haya sido entrenado con pocas mayúsculas lo que hace que falle en estos casos. Además el afrikaans deberá tener rigramas y frecuencias parecidas al inglés.

## Bonus points

## Sobre similitud coseno
